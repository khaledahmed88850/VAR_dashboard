  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: BlocListener<RiskQuestionsCubit, RiskQuestionsState>(
          listener: (context, state) {
            if (state is RiskQuestionsSuccess) {
              massengerMessage(
                context: context,
                message: 'Category Added',
                color: successColor,
              );
            } else if (state is RiskQuestionsFailure) {
              massengerMessage(
                context: context,
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomTextField(
                        ...
                        controller:
                            context.read<RiskQuestionsCubit>().question1,
                      ),
                      SizedBox(height: 8),
                      CustomTextField(
                        labelText: 'Answer 1',
                      ...
                      CustomTextField(
                        ...
                        controller:
                            context.read<RiskQuestionsCubit>().question2,
                      ),
                      SizedBox(height: 8),
                      CustomTextField(
                        labelText: 'Answer 2',
                      ...
                      CustomTextField(
                        ...
                        controller:
                            context.read<RiskQuestionsCubit>().question3,
                      ),
                      SizedBox(height: 8),
                      CustomTextField(
                        labelText: 'Answer 3',
                      ...
                      CustomTextField(
                        ...
                        controller:
                            context.read<RiskQuestionsCubit>().question4,
                      ),
                      SizedBox(height: 8),
                      CustomTextField(
                        labelText: 'Answer 4',
